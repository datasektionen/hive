...
pub async fn get_self_service_text<'x, X>(
    integration_id: &str,
    tag_id: &str,
    username: &str,
    db: X,
...
pub async fn set_self_service_text<'x, X>(
    integration_id: &str,
    tag_id: &str,
    username: &str,
    value: &str,
...
pub async fn get_self_service_bool<'x, X>(
    integration_id: &str,
    tag_id: &str,
    username: &str,
    db: X,
...
pub async fn set_self_service_bool<'x, X>(
    integration_id: &str,
    tag_id: &str,
    username: &str,
    value: bool,
